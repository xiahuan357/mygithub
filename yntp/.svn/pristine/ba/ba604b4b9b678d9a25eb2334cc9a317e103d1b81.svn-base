...
define(function(require, exports, module) {
    ...
    // 自定义：组件的html模板
    var template = require("./index_scenic.tpl");
		...
		$.ajax({
			...
			success : function(resultdata) {
				if (resultdata && resultdata.flag == "000000") {
					...
					var tabattrs = {};
					tabattrs.id = "scenicTabble";
					tabattrs.tabs = tabstatus;
					
					var ScenicTabbed = new TabbedComponent({
						attrs :  tabattrs,
						renderTo : "scenicTabbleWrapperDiv",
					});
					
					$("#scenicTabble ul").addClass("nav-tabs-simple");
					$("#scenicTabble ul").append('<div class="  pull-right  " style="margin-top:10px;">' +
	...
	var initScenicList = function(typeid) {
