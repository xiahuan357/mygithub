...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE=GLOBAL.BASE + "admin/hotel/hoteltype/delete";
	var TABLEOPTURL_QUERY=GLOBAL.BASE + "admin/hotel/hoteltype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/hotel/sys_hotel_type_form.html";
	var MODULENAME = "hotel_type";
		...
		table_attr : {
			...
			},
			{
				...
				"mRender" : function(data, type, full) {
					...
					+ '<a href="#" class="btn contrast icon-trash table_btn_delete" title="删除" style="margin-left:5px;margin-right:100px"> </a>';
				}
			}]
		}
	};
	...
	exports.init = function(){
		$(document).ready(function() {
			...
			// 查看详情
			$('#' + COMPONENTID_TABLE + " tbody").on("click", ".name", function(e)
			{
				var rowNode = this.parentNode.parentNode;
				var rowData = $('#' + COMPONENTID_TABLE).dataTable().fnGetData(rowNode);
				
				store.set("currentSelectNewsId", rowData.id);
				basearchiveUtil.jumpToHtml(GLOBAL.HTML_HOME + "background/news/newsdetail_bg.html" );
//				// 切换到详情界面
//				var productdetailtools = require("news_detailtools");
//	            productdetailtools.tonoticedetail(
//	            {
//	                "id" : rowData.id
//	            });
			});
