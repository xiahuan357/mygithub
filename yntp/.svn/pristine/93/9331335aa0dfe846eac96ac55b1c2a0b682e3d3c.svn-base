...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/hotel/hotelbedtype/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/hotel/hotelbedtype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/hotel/sys_hotel_bed_type_form.html";
