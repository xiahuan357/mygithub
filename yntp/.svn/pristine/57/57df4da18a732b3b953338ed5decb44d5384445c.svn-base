...
@Service
@Transactional
public class TourismlinePropertyService extends BaseServiceImpl<TourismlinePropertyEntity, Long>{
  ...
  public List<SelectOptionVO> getSelectOptionVO(){
    ...
    hql.append(" select new com.yn.yntp.common.web.vo.SelectOptionVO(T1.id,T1.name) from TourismlinePropertyEntity T1");
