...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/customer/business/tourismline/biz_tourismline_table.html";
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 第三个图片管理
			var ThirdComponent = require("./biz_tourismline_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/tourismline/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/tourismline/" + userInfo.id + "/updatewithimage";
				...
				var tourismlineEntity = $.extend({},firstData,secondData,thirdData);
				...
				postData ={
						currentEntity : tourismlineEntity,
