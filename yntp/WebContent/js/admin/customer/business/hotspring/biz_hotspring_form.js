...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/customer/business/hotspring/biz_hotspring_table.html";
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 第一个基本信息
			var FirstComponent = require("./biz_hotspring_baseinfo");
			// 第二个扩展信息
			var SecondComponent = require("./biz_hotspring_extendinfo");
			// 第三个图片管理
			var ThirdComponent = require("./biz_hotspring_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/hotspring/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/hotspring/" + userInfo.id + "/updatewithimage";
				...
				var hotspringEntity = $.extend({},firstData,secondData,thirdData);
