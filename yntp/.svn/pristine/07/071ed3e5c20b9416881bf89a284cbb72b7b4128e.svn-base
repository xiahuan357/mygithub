...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/scenic/scenictickettype/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/scenic/scenictickettype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/scenic/sys_scenic_ticket_type_form.html";
