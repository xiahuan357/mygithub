...
@Controller
@RequestMapping("/admin/hotel/hotelbedtype")
public class HotelBedTypeController extends BaseCRUDController<HotelBedTypeEntity, Long> {

  private HotelBedTypeService getHotelBedTypeService(){
    return (HotelBedTypeService)getBaseService();
  }
  ...
  public Object searchSelectModel(){
    ...
    ret.setData(getHotelBedTypeService().getSelectOptionVO());
    return ret;
  }
}
