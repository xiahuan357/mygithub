...
define(function(require, exports, module) {
    ...
    var FlowNatioanlFeature = require("./flownationalfeature/flownationalfeature");
	...
	exports.init = function(param) {
		...
		new FlowNatioanlFeature({
			renderTo : param.flowNationalFeatureWrapperDiv,
		})
		...
		//----------设置选中菜单样式 START
		var linode = $("#nationalfeature_page");
