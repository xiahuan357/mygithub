...
$.extend($.validator, {
	...
	prototype: {
		...
		init: function() {
			...
			function delegate(event) {
				...
				// Check null by liuchchc 2014-7-24 14:25:00
				if (!validator) return;
	...
	methods: {
		...
		mobortel: function( value, element ) {
			return this.optional(element) || /^1[3-8]\d{9}$/.test(value) || /^(([0\+]\d{2,3}-)?(0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$/.test(value);
		},
