...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/sys/scenic/sys_scenic_ticket_type_table.html";
	...
	function initFormValue(optType,data){
		...
		if (optType == basearchiveUtil.FORMOPT_CREATE) {
			...
			// 重新从数据库中读取数据
			var queryUrl = GLOBAL.BASE +  "admin/scenic/scenictickettype/search?q=id=" + data.id;
			var lastdata = null;
			$.ajax({
				async : false,
				type : "GET",
