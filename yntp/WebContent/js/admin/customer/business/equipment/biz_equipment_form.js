...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/customer/business/equipment/biz_equipment_table.html";
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 增加节点导航：1 填写基本信息；2 填写扩展信息；3 图库管理
			...
			// 第一个基本信息
			var FirstComponent = require("./biz_equipment_baseinfo");
			// 第二个扩展信息
			var SecondComponent = require("./biz_equipment_extendinfo");
			// 第三个图片管理
			var ThirdComponent = require("./biz_equipment_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/equipment/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/equipment/" + userInfo.id + "/updatewithimage";
