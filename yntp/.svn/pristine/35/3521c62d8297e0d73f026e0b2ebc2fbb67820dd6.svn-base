...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE=GLOBAL.BASE + "admin/hotspring/hotspringtype/delete";
	var TABLEOPTURL_QUERY=GLOBAL.BASE + "admin/hotspring/hotspringtype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/hotspring/sys_hotspring_type_form.html";
	var MODULENAME = "hotspring_type";
