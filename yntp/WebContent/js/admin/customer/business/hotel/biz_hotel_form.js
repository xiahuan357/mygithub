...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/customer/business/hotel/biz_hotel_table.html";
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 第一个基本信息
			var FirstComponent = require("./biz_hotel_baseinfo");
			// 第二个扩展信息
			var SecondComponent = require("./biz_hotel_extendinfo");
			// 第三个图片管理
			var ThirdComponent = require("./biz_hotel_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/hotel/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/hotel/" + userInfo.id + "/updatewithimage";
				...
				var hotelEntity = $.extend({},firstData,secondData,thirdData);
