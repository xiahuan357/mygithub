package com.yn.yntp.module.sys.user.utils;
 ...
 * 
 * 
 * @Title: UserLogUtils.java 
 * @Package com.yn.yntp.module.sys.user.utils 
 * @Description: TODO(用一句话描述该文件做什么) 
 *
 * @author liucc    
 * @date 2014年12月12日 下午12:50:29 
 * @version V1.0
 */
public class UserLogUtils {

    private static final Logger SYS_USER_LOGGER = LoggerFactory.getLogger(UserLogUtils.class);
