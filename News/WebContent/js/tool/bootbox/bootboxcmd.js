 ...
 * @history
 * 1 alertTimeout函数增加回调函数功能，隐藏对话框后，执行回调 - liuchchc - 2014-5-28 13:44:06
 */
		...
		var p = "en", t = "en", u = !0, s = "static", v = "", l = {}, g = {}, m = {
			...
			alertTimeout : function(){
				...
				switch(arguments.length) {
					...
					case 2:
						b = arguments[0];
						"function" == typeof arguments[1] ? c = arguments[1] : time = arguments[1];
						break;
					case 3:
						b = arguments[0];
			...
			dialog : function(b, a, c) {
				...
				for (var d = a.length; d--; ) {
					...
					a[d]["class"] ? j = a[d]["class"] : d == 0 && 2 >= a.length && ( j = "btn-primary contrast-background");
				...
				d = ["<div class='bootbox modal' tabindex='-1' style='overflow:hidden; width:30%'>"];
				if (c.header) {
					j = "";
