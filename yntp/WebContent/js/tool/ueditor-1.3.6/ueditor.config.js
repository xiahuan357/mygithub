...
(function () {
     ...
     */
	var URL = window.UEDITOR_HOME_URL || GLOBAL.BASE + "js/tool/ueditor-1.3.6/";
	window.UEDITOR_HOME_URL = GLOBAL.BASE + "js/tool/ueditor-1.3.6/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        ///hadoop_test/hbase/ueditorfileupload.do?fileSetKey=shanchong100012
        //图片上传配置区   jsp/imageUp.jsp
//        ,imageUrl: baseRoot+"notice/ueditorpicupload.do?fileSetKey=shanchong100012"             //图片上传提交地址
//        ,imagePath: baseRoot                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        //附件上传配置区
//        ,fileUrl: baseRoot+"notice/ueditorfileupload.do?fileSetKey=shanchong100012"               //附件上传提交地址
//        ,filePath: baseRoot                   //附件修正地址，同imagePath
