...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/ads/adspicture/deletewithimage";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/ads/adspicture/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/ads/sys_ads_picture_form.html";
