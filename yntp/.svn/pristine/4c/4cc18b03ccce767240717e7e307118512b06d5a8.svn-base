 ...
 * 
 * 
 * @Title: ScenicLevelValidate.java
 * @Package com.yn.yntp.module.scenic.validate
 ...
 */
@Component
public class ScenicLevelValidate extends
    DefaultValidate<ScenicLevelEntity, Long> {
  @Autowired
  private ScenicLevelService scenicLevelService;
  ...
  public ReturnInfo validateCreate(Object... param) {
    ...
    List<ScenicLevelEntity> resultList = scenicLevelService.query(parsedQuery);
  ...
  public ReturnInfo validateDelete(Object... param) {
    ...
    List<Triple<String, ClientOperation, String>> parsedQuery =
        new ArrayList<Triple<String, ClientOperation, String>>();
    parsedQuery.add(new ImmutableTriple<String, ClientOperation, String>("level_id",
