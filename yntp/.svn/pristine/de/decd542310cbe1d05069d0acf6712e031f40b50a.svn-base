...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/hotel/hotellevel/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/hotel/hotellevel/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/hotel/sys_hotel_level_form.html";
	var MODULENAME = "hotel_level";
