...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/tourismline/tourismlinetheme/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/tourismline/tourismlinetheme/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/tourismline/sys_tourismline_theme_form.html";
