...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/business/hotspring/deletewithimage/";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/customer/business/hotspring/biz_hotspring_form.html";
	var tableUrl_room = GLOBAL.HTML_HOME + "admin/customer/business/hotspring/biz_hotspring_room_table.html";
	var MODULENAME = "hotspring";
	...
	exports.init = function(){
		$(document).ready(function() {
			...
			var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/business/hotspring/pagesearch/"+userInfo.id+"/hotspringlist";
