 ...
 * 
 * 
 * @Title: ScenicTicketTypeValidate.java
 * @Package com.yn.yntp.module.scenic.validate
 ...
 */
@Component
public class ScenicTicketTypeValidate extends
    DefaultValidate<ScenicTicketTypeEntity, Long> {
  @Autowired
  ...
  public ReturnInfo validateDelete(Object... param) {
    ...
    List<Triple<String, ClientOperation, String>> parsedQuery =
        new ArrayList<Triple<String, ClientOperation, String>>();
    parsedQuery.add(new ImmutableTriple<String, ClientOperation, String>("type_id",
