...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/equipment/equipmenttype/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/equipment/equipmenttype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/equipment/sys_equipment_type_form.html";
