...
//        UserOnlineEntity userOnline = userOnlineService.queryById(String.valueOf(sessionId));
//        if (userOnline == null) {
//            return null;
//        }
//        return onlineSessionFactory.createSession(userOnline);
    ...
    public void syncToDb(OnlineSession session) {
        ...
        userOnlineService.online(UserOnlineEntity.fromOnlineSession(session));
