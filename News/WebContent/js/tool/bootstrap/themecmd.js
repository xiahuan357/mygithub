define(function(require, exports, module)
{
    ...
    require("autosize");
    require("charCount");
    require("bootstrap_maxlength");
    require("jquery.ui.sortable");
    require("bootstrap_datetimepicker");
    //require("bootstrap_editable");
    //require("bootstrap_wysihtml5");
    //require("jquery.nestableSea");
    //require("tabdrop");
    //require("bootstrap_naked_password");
    //require("jquery.slimscroll");
    //require("bootstrap_modernizr");
    //require("bootstrap_colorpicker");
    //require("bootstrap_fileinput");
    require("jquery.dataTables");
    require("jquery-ui");
    require("bootstrap_nav");
    ...
    (function()
    {
        ...
        this.setValidateForm = function(selector, fnsubmithandler)
        {
            if (selector == null)
            {
        ...
        //	        sdom = "<'row-fluid datatables-top'<'span6'l><'span6 text-right'pf>r>t<'row-fluid
        // datatables-bottom'<'span6'i><'span6 text-right'p>>";
        //	      } else if ($(elem).data("pagination-top") === true) {
        //	        sdom = "<'row-fluid datatables-top'<'span6'l><'span6 text-right'pf>r>t<'row-fluid
        // datatables-bottom'<'span6'i><'span6 text-right'>>";
        //	      } else {
        //	        sdom = "<'row-fluid datatables-top'<'span6'l><'span6 text-right'f>r>t<'row-fluid
        // datatables-bottom'<'span6'i><'span6 text-right'p>>";
        //	      }
        //	      dt = $(elem).dataTable({
        //	        sDom: sdom,
        ...
        module.exports.setValidateForm = this.setValidateForm;
