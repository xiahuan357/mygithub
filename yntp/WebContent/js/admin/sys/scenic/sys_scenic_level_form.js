...
define(function(require, exports, module) {
	...
	var FORMOPTURL_INSERT= GLOBAL.BASE + "admin/scenic/sceniclevel/create";
	var FORMOPTURL_UPDATE= GLOBAL.BASE + "admin/scenic/sceniclevel/update";
	
	var TARGETDIV_FORM = "basearchive_form";
	var MODULENAME = "scenic_level";
	
	var COMPONENTID_FORM = "validationform" + "_" + MODULENAME;
	
	var tableUrl = GLOBAL.HTML_HOME + "admin/sys/scenic/sys_scenic_level_table.html";
	...
	function initFormValue(optType,data){
		...
		if (optType == basearchiveUtil.FORMOPT_CREATE) {
			...
			// 重新从数据库中读取数据
			var queryUrl = GLOBAL.BASE +  "admin/scenic/sceniclevel/search?q=id=" + data.id;
			var lastdata = null;
			$.ajax({
				async : false,
				type : "GET",
