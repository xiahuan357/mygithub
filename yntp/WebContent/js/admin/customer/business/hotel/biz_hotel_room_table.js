...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/business/hotelroom/deletewithimage/";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/customer/business/hotel/biz_hotel_room_form.html";
	...
	var param = {
		...
		table_attr : {
			...
			},
			{
				"aTargets" : [ 2 ],
				"sTitle" : "房间类型",
				"mData" : "hotelRoomTypeEntity.name",
			},
			{
				"aTargets" : [ 3 ],
				"sTitle" : "操作",
	...
	exports.init = function(){
		$(document).ready(function() {
			...
			var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/business/hotelroom/pagesearch/"+hotelInfo.id+"/roomlist";
