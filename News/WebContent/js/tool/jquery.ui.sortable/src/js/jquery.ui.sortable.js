define(function(require, exports, module) {
	return function(jQuery) {
		 ...
		 * 
		 * Copyright 2012, AUTHORS.txt (http://jqueryui.com/about) Dual licensed
							...
							$.ui.mouse,
							{
								...
								_mouseDrag : function(event) {
									...
									for ( var i = this.items.length - 1; i >= 0; i--) {
										...
										// only rearrange items within the same
										// container
										) {
								...
								_intersectsWithPointer : function(item) {
									...
									var isOverElementHeight = $.ui.isOverAxis(
											...
											item.top, item.height), isOverElementWidth = $.ui
								...
								_intersectsWithSides : function(item) {
									...
									var isOverBottomHalf = $.ui.isOverAxis(
											...
											item.height), isOverRightHalf = $.ui
											.isOverAxis(this.positionAbs.left
													+ this.offset.click.left,
													item.left
															+ (item.width / 2),
								...
								_createHelper : function(event) {
									...
									if (!helper.parents('body').length) // Add
																		// the
																		// helper
																		// to
																		// the
								...
								_clear : function(event, noPropagation) {
									...
									if (this._storedCursor)
										$('body').css("cursor",
												this._storedCursor); // Reset
																		// cursor
									if (this._storedOpacity)
										this.helper.css("opacity",
												this._storedOpacity); // Reset
																		// opacity
