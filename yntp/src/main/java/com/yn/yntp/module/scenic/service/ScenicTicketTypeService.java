...
@Service
@Transactional
public class ScenicTicketTypeService extends BaseServiceImpl<ScenicTicketTypeEntity, Long> {
  ...
  public List<SelectOptionVO> getSelectOptionVO(){
    ...
    hql.append(" select new com.yn.yntp.common.web.vo.SelectOptionVO(T1.id,T1.name) from ScenicTicketTypeEntity T1");
