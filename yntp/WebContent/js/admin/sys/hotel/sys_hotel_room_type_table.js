...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/hotel/hotelroomtype/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/hotel/hotelroomtype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/hotel/sys_hotel_room_type_form.html";
	var MODULENAME = "hotel_room_type";
