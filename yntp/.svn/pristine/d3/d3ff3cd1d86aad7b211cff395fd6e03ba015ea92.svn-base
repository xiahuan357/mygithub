...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/tourismline/tourismlineproperty/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/tourismline/tourismlineproperty/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/tourismline/sys_tourismline_property_form.html";
