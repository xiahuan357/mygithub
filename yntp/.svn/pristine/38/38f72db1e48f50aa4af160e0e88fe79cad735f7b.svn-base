...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/business/equipment/deletewithimage/";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/customer/business/equipment/biz_equipment_form.html";
	var MODULENAME = "equipment";
	...
	exports.init = function(){
		$(document).ready(function() {
			...
			var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/business/equipment/pagesearch/"+userInfo.id+"/equipmentlist";
