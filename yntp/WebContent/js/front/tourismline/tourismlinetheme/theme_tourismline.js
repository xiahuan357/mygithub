...
define(function(require, exports, module) {
	...
	var MODULE = "theme_tourismline";
	
	/** 查询线路类型，在tabbed页签显示*/
	var type_query = GLOBAL.BASE + "front/tourismline/tourismlinetheme/search?q=";
    ...
    // 自定义：组件的html模板
    var template = require("./theme_tourismline.tpl");
		...
		$.ajax({
			...
			success : function(resultdata) {
				if (resultdata && resultdata.flag == "000000") {
					...
					var tabattrs = {};
					tabattrs.id = "themeTourismlineTabble";
					tabattrs.tabs = tabstatus;
					
					var TourismlineTabbed = new TabbedComponent({
						attrs :  tabattrs,
						renderTo : "themeTourismlineTabbleWrapperDiv",
					});
					
					$("#themeTourismlineTabble ul").addClass("nav-tabs-simple");
					$("#themeTourismlineTabble ul").append('<div class="  pull-right  " style="margin-top:10px;">' +
