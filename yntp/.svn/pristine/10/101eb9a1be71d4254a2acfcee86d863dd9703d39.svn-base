...
define(function(require, exports, module) {
	...
	var modemailurl = GLOBAL.HTML_HOME + "admin/customer/business/baseinfo/biz_business_modemail_form.html";
	var modpwurl = GLOBAL.HTML_HOME + "admin/customer/business/baseinfo/biz_business_modpw_form.html";
