...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE=GLOBAL.BASE + "admin/planticket/delete";
	var TABLEOPTURL_QUERY=GLOBAL.BASE + "admin/planticket/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/planticket/sys_planticket_book_form.html";
