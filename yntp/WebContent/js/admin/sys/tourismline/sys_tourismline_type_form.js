...
define(function(require, exports, module) {
	...
	var FORMOPTURL_INSERT= GLOBAL.BASE + "admin/tourismline/tourismlinetype/create";
	var FORMOPTURL_UPDATE= GLOBAL.BASE + "admin/tourismline/tourismlinetype/update";
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/sys/tourismline/sys_tourismline_type_table.html";
	...
	function initFormValue(optType,data){
		...
		if (optType == basearchiveUtil.FORMOPT_CREATE) {
			...
			// 重新从数据库中读取数据
			var queryUrl = GLOBAL.BASE +  "admin/tourismline/tourismlinetype/search?q=id=" + data.id;
			var lastdata = null;
			$.ajax({
				async : false,
				type : "GET",
