...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/customer/business/nationalspecial/biz_nationalspecial_table.html";
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 第一个基本信息
			var FirstComponent = require("./biz_nationalspecial_baseinfo");
			// 第二个扩展信息
			var SecondComponent = require("./biz_nationalspecial_extendinfo");
			// 第三个图片管理
			var ThirdComponent = require("./biz_nationalspecial_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/nationalspecial/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/nationalspecial/" + userInfo.id + "/updatewithimage";
				...
				var nationalSpecialEntity = $.extend({},firstData,secondData,thirdData);
				...
				postData ={
						currentEntity : nationalSpecialEntity,
