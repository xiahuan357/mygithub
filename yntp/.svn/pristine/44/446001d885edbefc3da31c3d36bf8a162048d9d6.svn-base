package com.yn.yntp.module.equipment.validate;
...
import com.yn.yntp.module.equipment.service.EquipmentService;
import com.yn.yntp.module.equipment.service.EquipmentTypeService;

/**
 * 
 * 
 * @Title: EquipmentTypeValidate.java 
 * @Package com.yn.yntp.module.equipment.validate 
 * @Description: TODO(用一句话描述该文件做什么) 
 *
 * @author cuilz    
 * @date 2014年11月24日 下午6:40:24 
 * @version V1.0
 */
@Component
public class EquipmentTypeValidate extends DefaultValidate<EquipmentTypeEntity,Long> {
  ...
  public ReturnInfo validateCreate(Object... param) {
    ...
    List<EquipmentTypeEntity> resultList =
        equipmentTypeService.query(parsedQuery);
  ...
  public ReturnInfo validateDelete(Object... param) {
    ...
    List<EquipmentEntity> resultList = equipmentService.query(parsedQuery);
    if (resultList != null && !resultList.isEmpty()) {
      rtn_info.setFlag(false);
      rtn_info.append("该类型已被使用，不能删除");
    }
    return rtn_info;
  }
