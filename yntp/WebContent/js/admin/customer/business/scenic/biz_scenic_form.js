...
define(function(require, exports, module) {
	...
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 第一个基本信息
			var FirstComponent = require("./biz_scenic_baseinfo");
			// 第二个扩展信息
			var SecondComponent = require("./biz_scenic_extendinfo");
			// 第三个图片管理
			var ThirdComponent = require("./biz_scenic_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/scenic/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/scenic/" + userInfo.id + "/updatewithimage";
				...
				var scenicEntity = $.extend({},firstData,secondData,thirdData);
