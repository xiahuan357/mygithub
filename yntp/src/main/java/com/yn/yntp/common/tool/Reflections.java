package com.yn.yntp.common.tool;
 ...
 *               被AOP过的真实类等工具函数.引用自网络
 *
 * @author liucc
 * @date 2014年11月21日 下午5:23:23
 * @version V1.0
 */
...
public class Reflections {
  ...
  public static Object invokeGetter(Object obj, String propertyName) {
    ...
    for (String name : StringUtils.split(propertyName, ".")) {
      ...
      object =
          invokeMethod(object, getterMethodName, new Class[] {},
              new Object[] {});
    }
    return object;
  }
  ...
  public static Method getAccessibleMethod(final Object obj,
    ...
    for (Class<?> searchType = obj.getClass(); searchType != Object.class; searchType =
      ...
      try {
        Method method =
            searchType.getDeclaredMethod(methodName, parameterTypes);
  ...
  public static void fatherToChild(Object father, Object child)
    ...
    for (int i = 0; i < ff.length; i++) {
      ...
      Method getterMethod = fatherClass.getMethod("get" + upperHeadChar(f.getName()));// 方法getDeleteDate
      Object paramObject = getterMethod.invoke(father);// 取出属性值
     
      Method setMethod = fatherClass.getMethod("set" + upperHeadChar(f.getName()),type);
      setMethod.invoke(child, new Object[]{paramObject}) ;//设置子类值
    }
  }
