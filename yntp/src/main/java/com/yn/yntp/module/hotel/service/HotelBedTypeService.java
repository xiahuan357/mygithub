...
import com.yn.yntp.module.hotel.dao.HotelBedTypeDAO;
...
@Service
@Transactional
public class HotelBedTypeService extends BaseServiceImpl<HotelBedTypeEntity, Long> {

  private HotelBedTypeDAO getHotelBedTypeDAO() {
    return (HotelBedTypeDAO) baseDao;
  }
  ...
  public List<SelectOptionVO> getSelectOptionVO(){
    ...
    hql.append(" select new com.yn.yntp.common.web.vo.SelectOptionVO(T1.id,T1.name) from HotelBedTypeEntity T1");
