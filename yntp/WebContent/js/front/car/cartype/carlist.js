...
define(function(require, exports, module) {
	...
	exports.init = function(param) {
		/** 查询租车，在tabbed内部显示*/
		var car_query = GLOBAL.BASE + "front/car/car/frontshow/fileds/pagesearch?start=0&size=8";
		car_query += "&q=type_id=" + param.type_id;
        handlebars.registerHelper('carlist', function(items, options) {
        	var dataList;
    		var listBlockOut = "";
            $.ajax({
            	async : false,
		...
		// 实例化组件-------------------------START
		var template = require("./carlist.tpl");
