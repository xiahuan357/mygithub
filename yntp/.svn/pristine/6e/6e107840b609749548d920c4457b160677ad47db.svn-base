...
define(function(require, exports, module) {
	...
	var tableUrl = GLOBAL.HTML_HOME + "admin/customer/business/car/biz_car_table.html";
	exports.init = function(param) {
		$(document).ready( function() {
			...
			// 第一个基本信息
			var FirstComponent = require("./biz_car_baseinfo");
			// 第二个扩展信息
			var SecondComponent = require("./biz_car_extendinfo");
			// 第三个图片管理
			var ThirdComponent = require("./biz_car_imagelibrary");
			...
			UXwizard.on('finished', function(e, data) {
				...
				var FORMOPTURL_INSERT = GLOBAL.BASE + "admin/business/car/" + userInfo.id + "/createwithimage";
				var FORMOPTURL_UPDATE = GLOBAL.BASE + "admin/business/car/" + userInfo.id + "/updatewithimage";
				...
				var carEntity = $.extend({},firstData,secondData,thirdData);
