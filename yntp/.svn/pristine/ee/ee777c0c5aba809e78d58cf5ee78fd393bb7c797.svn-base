...
define(function(require, exports, module) {
	...
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/region/region/pagesearch?q=parent_id=0";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/region/sys_region_form_fir.html";
	...
	var param = {
		...
		table_attr : {
			...
			},
			{
				...
				"mData" : null,
				"mRender" : function(data, type, full) {
					return '<input class="btn btn-link first_btn_next"  type="button" value="下一级" style="margin-bottom:5px">';
				}
			},
			{
				"aTargets" : [ 3 ],
	...
	exports.init = function(){
		$(document).ready(function() {
			...
			//Table页面跳转到下一级
			$('.first_btn_next').die().live('click',function(e){
