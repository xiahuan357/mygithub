...
public class CreatCancelDeleteImageAction  extends ActionSupport {
	...
	public void createCancelDeleteImage(HttpServletRequest request) {
		    ServletContext sc = request.getSession().getServletContext();
		    String serverBase = sc.getRealPath("/");
  
		  
				clearFolderImage(serverBase, this.imagekey);
