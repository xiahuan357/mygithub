...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE=GLOBAL.BASE + "admin/car/cartype/delete";
	var TABLEOPTURL_QUERY=GLOBAL.BASE + "admin/car/cartype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/car/sys_car_type_form.html";
