...
define(function(require, exports, module) {
	...
	var FORMOPTURL_DELETE = GLOBAL.BASE + "admin/tourismline/tourismlinetype/delete";
	var TABLEOPTURL_QUERY = GLOBAL.BASE + "admin/tourismline/tourismlinetype/pagesearch";
	
	var TARGETDIV_TABLE = "basearchive_table";
	
	var COMPONENTID_TABLE = "pagedatatable";
	var formUrl = GLOBAL.HTML_HOME + "admin/sys/tourismline/sys_tourismline_type_form.html";
